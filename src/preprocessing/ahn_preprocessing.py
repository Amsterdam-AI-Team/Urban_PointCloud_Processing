...
def process_ahn_las_tile(ahn_las_file, out_folder='', resolution=0.1):
    ...
    # Voor grond wil je smooth service (IDW). Voor gebouwen willen we upper threshold voor hoekjes voor gebouwen.
    ...
    bridge_surface = _get_ahn_surface(ahn_las, grid_x, grid_y, 'idw',
                                      AHN_ARTIFACT, power=2.)
